    ...
    row.update(
        csv_stats(
            ...
            [
                ...
                "arb2_q_s",
                "arb2_q_g",
                "arb2_semantic_authoritative",
                "arb2_geodf_authoritative",
                "arb2_joint_authoritative",
                "arb2_no_authoritative",
                "arb2_disagreement",
                "arb2_keep",
                "arb2_downweight",
                "arb2_quarantine",
                "arb2_hard_reject",
                "arb2_mean_q_m",
                "arb2_mean_dynamic_weight",
                "arb2_mean_final_weight",
                "arb2_mean_expert_agreement",
            ],
        )
    )
    row.update(
