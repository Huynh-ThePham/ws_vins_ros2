...
namespace {
void set_stamp_from_sec(builtin_interfaces::msg::Time &stamp, double t)
{
    const int64_t ns = static_cast<int64_t>(t * 1e9);
...
void GlobalOptimization::inputOdom(double t, Eigen::Vector3d OdomP, Eigen::Quaterniond OdomQ)
{
    ...
    set_stamp_from_sec(pose_stamped.header.stamp, t);
...
void GlobalOptimization::updateGlobalPath()
{
    ...
    {
        geometry_msgs::msg::PoseStamped pose_stamped;
        set_stamp_from_sec(pose_stamped.header.stamp, iter->first);
        pose_stamped.header.frame_id = "world";
