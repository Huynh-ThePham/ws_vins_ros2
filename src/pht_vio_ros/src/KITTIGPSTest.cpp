...
int main(int argc, char** argv)
{
	...
	if(argc != 3)
	{
		printf("please intput: ros2 run pht_vio_ros kitti_gps_test [config file] [data folder] \n"
			   "for example: ros2 run pht_vio_ros kitti_gps_test "
			   "$(ros2 pkg prefix pht_vio_ros)/share/pht_vio_ros/config/kitti_raw/kitti_10_03_config.yaml "
