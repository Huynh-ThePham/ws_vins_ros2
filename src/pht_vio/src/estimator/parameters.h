...
struct VinsConfig
{
    ...
    int sem_mask_gated = 1;
    std::string sem_stats_path;

    // GeoDF / SGTA-VINS: geometry-aware dynamic feature rejection.
    int geodf_enable = 0;
    ...
    double geodf_reject_ratio_max = 0.40;
    ...
    double geodf_deactivate_frac = 0.60;
    int geodf_auto_rho = 1;
    ...
    int geodf_vote_frames = 2;
    int geodf_warmup_frames = 30;
    double geodf_temporal_alpha = 0.45;
    double geodf_dynamic_prob_th = 0.55;
    int sgta_policy_enable = 1;
    double sgta_policy_ema_alpha = 0.15;
    double sgta_policy_decay_alpha = 0.03;
    double sgta_aggressive_sem_on = 0.025;
    double sgta_aggressive_sem_off = 0.016;
    int sgta_aggressive_hold_frames = 60;
    double sgta_aggressive_activate_ratio = 0.050;
    double sgta_aggressive_dynamic_prob_th = 0.45;
    int sgta_aggressive_vote_frames = 1;
    int sgta_aggressive_warmup_frames = 0;
