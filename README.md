...
| [`paper/sad-vins-2026`](https://github.com/Huynh-ThePham/ws_vins_ros2/tree/paper/sad-vins-2026) | SGTA-VINS (+ SAD ablation) — see [docs/SGTA-VINS-FREEZE.md](docs/SGTA-VINS-FREEZE.md) |
